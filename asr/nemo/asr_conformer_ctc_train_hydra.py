...
def main(cfg):
    ...
    cfg.model.tokenizer.dir = "scripts/tokenizers/ksponspeech/tokenizer_spe_unigram_v5000/"  # note this is a directory, not a path to a vocabulary file
    ...
    train_manifest = 'scripts/ksponspeech/train_manifest.json'
    dev_manifest = 'scripts/ksponspeech/dev_manifest.json'
